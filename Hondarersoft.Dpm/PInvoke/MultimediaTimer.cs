...
namespace Hondarersoft.Dpm.PInvoke
{
    /// <summary>
    /// 
    /// </summary>
    public static partial class PInvoke
    {
        ...
        public static extern int TimeSetEvent(int uDelay, int uResolution, MultimediaTimerCallback fptc, IntPtr dwUser, TimerFlag fuEvent);
        ...
        public delegate void MultimediaTimerCallback(int timerID, int msg, IntPtr instance, IntPtr param1, IntPtr param2);
